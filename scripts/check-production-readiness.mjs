...
assert(homePage.includes("Get a free systems audit"), "Make the homepage primary CTA a concrete free audit offer.");
assert(homePage.includes("Built around operating needs"), "Use proof language grounded in operating systems.");
...
assert(header.includes("Free systems audit"), "Header CTA should point to the concrete audit offer.");
...
assert(homePage.includes('id="faq"') || homePage.includes("What to know before you submit"), "Add an FAQ section for conversion and search intent.");
